package veniamin.shop.backend.utils;
...
public class MimeTypesUtil {
    ...
    public static final String MIME_APPLICATION_PPTX = "application/vnd.openxmlformats-officedocument.presentationml.presentation";
    ...
    static {
        mimeTypeMapping = new HashMap<String, String>(200) {
...

            {
                ...
                put1("pptx", MIME_APPLICATION_PPTX);
            }
        };
    }
    ...
    static {
        extMapping = new HashMap<String, String>(200) {
...

            {
                ...
                put1(MIME_APPLICATION_PPTX, "pptx");
            }
        };
    }
